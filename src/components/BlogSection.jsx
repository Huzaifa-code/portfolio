...
const BlogLink = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center md:my-11'>
        ...
        <div className='flex md:flex-row flex-col justify-center md:gap-16 p-8 '>
            {posts.map((post) => (
                <Link to={`/blog/${post.slug.current}`} key={post.slug.current} className='md:w-1/4 my-4 md:my-0'>
